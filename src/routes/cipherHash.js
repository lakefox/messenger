...
export function unCipherHash(msg, passPhrase) { return unCipherHash1(msg, passPhrase) };
export function cipherHash(msg, passPhrase) { return cipherHash1(msg, passPhrase) };
export function hash(data) { return hash1(data) };
